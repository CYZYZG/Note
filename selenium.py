...
browser.get("http://flight.qunar.com/")  #打开去哪儿官网
a=browser.get_screenshot_as_file("E:/Python27/test2.jpg")  #屏幕截图
...
browser.find_element_by_xpath('//*[@id="dfsForm"]/div[2]/div[1]/div/input').send_keys(u"北京")  #输入起点位置
...
browser.quit()
driver.maximize_window()  # 最大化窗口，因为每一次爬取只能看到视窗内的图片 